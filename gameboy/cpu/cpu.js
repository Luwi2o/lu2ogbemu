...
import { CPUDebug } from './cpu_debug.js';
import {
    A,
    F,
    B,
...
export class CPU{
    ...
    constructor(memoria, interrupciones, tipoConsola, cPUDebug, estado){
         ...
         * @returns 
         */
        this.ld_r_mrr_8b = (regd, regmemh, regmeml, offset) => {
         ...
         * @param {number} regmem Registro de dirección
         * @param {number} reg Registro de origen
         * @returns 
         */
         ...
         * @param {*} regdh Registro H de origen
         * @param {*} regdl Registro L de origen
         * @param {*} regsh Registro H de destino
         * @param {*} regsl Registro L de destino
         */
        this.ld_rr_rr_16b = (regdh, regdl, regsh, regsl) => {
         ...
         * regd = regd + regds
         * @param {*} regd Registro de destino.
         * @param {*} regmemh Registro de origen.
         * @param {*} regmeml Registro de origen.
         */
        this.add_r_mrr_8b = (regd, regmemh, regmeml) => {
         ...
         * @returns 
         */
        this.adc_r_mrr_8b = (regd, regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits( this.registros.R[regmeml], this.registros.R[regmemh]) );
         ...
         * @param {*} regd Registro destino
         * @param {*} regmemh Registro parte alta de la direccion
         * @param {*} regmeml Registro parte baja de la direccion
         */
        this.sub_r_mrr_8b = (regd, regmemh, regmeml) => {
            ...
            if(this.registros.R[regd] == 0) this.Z = 1;
            this.ciclos = 8;
            this.cPUDebug.instruccionStr = "sub_r_mrr_8b" + 
            (this.nombreR(regd) ?? "")  + " (" + 
            (this.nombreR(regmemh) ?? "") 
            + (this.nombreR(regmeml) ?? "")  + ")";
        }
         ...
         * @param {*} regmeml 
         */
        this.sbc_r_mrr_8b = (regd, regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits( this.registros.R[regmeml], this.registros.R[regmemh]) );
            var res = this.registros.R[regd] - (regfrommem + this.C);
            var resH = (this.registros.R[regd] & 0x0F) - (regfrommem & 0x0F) - this.C
         ...
         * @param {*} regmeml 
         */
        this.and_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
         ...
         * @param {*} regmeml 
         */
        this.or_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits( this.registros.R[regmeml], this.registros.R[regmemh] ));
            var res = this.registros.R[A] | regfrommem;
            this.registros.R[A] = res;
         ...
         * @param {*} regmeml 
         */
        this.xor_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
            var res = this.registros.R[A] ^ regfrommem;
            this.registros.R[A] = res;
         ...
         * @param {*} regmemh
         */
        this.cp_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
            var res = this.registros.R[A] - regfrommem;
            this.Z = 0, this.H = 0, this.C = 0, this.N = 1;
         ...
         * @param {*} regmeml 
         */
        this.inc_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
         ...
         * @param {*} regmeml 
         */
        this.dec_mrr_8b = (regmemh, regmeml) => {
         ...
         * @param {*} regls 
         */
        this.add_rr_rr_16b = (reghd, regld, reghs, regls) => {
         ...
         * @param {*} regld 
         */
        this.add_rr_sp_16b = (reghd, regld) => {
            var regd = this.registros.leer16Bits(reghd, regld);
         ...
         * @param {*} regmeml 
         */
        this.swap_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
         ...
         * @param {*} regmeml 
         */
        this.rlc_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
         ...
         * @param {*} regmeml 
         */
        this.rl_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
            var bit7 = (regfrommem & 0x80) >> 7;
         ...
         * @param {*} regmeml 
         */
        this.rrc_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
         ...
         * @param {*} regmeml 
         */
        this.rr_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
            var bit0 = (regfrommem & 0x01);
         ...
         * @param {*} regmeml 
         */
        this.sla_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
            var bit7 = (regfrommem & 0x80) >> 7;
            var res = (regfrommem << 1) & 0xFF;
         ...
         * @param {*} regmeml 
         */
        this.sra_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
            var bit0 = (regfrommem & 0x01);
         ...
         * @param {*} regmemh 
         */
        this.srl_mrr_8b = (regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
            var bit0 = (regfrommem & 0x01);
            var res = (regfrommem >> 1) & 0xFF;
         ...
         * @param {*} regmeml 
         */
        this.bit_nbit_mrr_b8 = (nbit, regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
         ...
         * @param {*} regmeml 
         */
        this.set_nbit_mrr_b8 = (nbit, regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
         ...
         * @param {*} regmeml 
         */
        this.res_nbit_mrr_b8 = (nbit, regmemh, regmeml) => {
            var regfrommem = this.memoria.leer8Bits(
                this.sinSigno16Bits(this.registros.R[regmeml], this.registros.R[regmemh]));
         ...
         * @param {*} regmeml 
         */
        this.jp_mrr_8b = (regmemh, regmeml) => {
    ...
    /**
     * Ejecuta la instrucción correspondiente al código de operación recibido.
     * @param {*} codigo 
     */
    ejecutar(codigo){
        ...
        switch(codigo){
            ...
            case 0x02: this.ld_mrr_r_8b(B, C, A, 0); break;
            ...
            case 0x0A: this.ld_r_mrr_8b(A, B, C, 0); break;
            ...
            case 0x12: this.ld_mrr_r_8b(D, E, A, 0); break;
            ...
            case 0x1A: this.ld_r_mrr_8b(A, D, E, 0); break;
            ...
            case 0x46: this.ld_r_mrr_8b(B, H, L, 0); break;
            ...
            case 0x4E: this.ld_r_mrr_8b(C, H, L, 0); break;
            ...
            case 0x56: this.ld_r_mrr_8b(D, H, L, 0); break;
            ...
            case 0x5E: this.ld_r_mrr_8b(E, H, L, 0); break;
            ...
            case 0x66: this.ld_r_mrr_8b(H, H, L, 0); break;
            ...
            case 0x6E: this.ld_r_mrr_8b(L, H, L, 0); break;
            case 0x6F: this.ld_r_r_8b(L ,A); break;

            case 0x70: this.ld_mrr_r_8b(H, L, B, 0); break;
            case 0x71: this.ld_mrr_r_8b(H, L, C, 0); break;
            case 0x72: this.ld_mrr_r_8b(H, L, D, 0); break;
            case 0x73: this.ld_mrr_r_8b(H, L, E, 0); break;
            case 0x74: this.ld_mrr_r_8b(H, L, H, 0); break;
            case 0x75: this.ld_mrr_r_8b(H, L, L, 0); break;
            case 0x76: this.halt(); break;
            case 0x77: this.ld_mrr_r_8b(H, L, A, 0); break;
            ...
            case 0x7E: this.ld_r_mrr_8b(A, H, L, 0); break;
    ...
    /**
     * Convierte dos bytes (lsb, msb) en un número de 16 bits sin signo.
     * @param {*} lsb 
     * @param {*} msb 
     * @returns 
     */
   ...
   ciclo(){
        ...
        const mem = this.memoria;
        const regs = this.registros;
        const dbg = this.cPUDebug;

        if (dbg?.activo) {
            mem.memoriaStr = "";
            mem.mostrarLogs = true;
        }
        ...
        if (dbg?.activo) {
            ...
            dbg.instruccionPC = pc.toString(16);
            dbg.codigoStr = opcode.toString(16);
            dbg.registros16Str = this.imprimirRegistros16Bits();
            dbg.registrosStr = this.imprimirRegistros8Bits();
            dbg.flagsStr = this.imprimirFlags();
        }
    }
    ...
    /**
     * Devuelve el nombre del registro según su código.
     * @param {*} registro 
     * @returns 
     */
    nombreR(registro){
    ...
    /**
     * Agrega un punto de interrupción en la dirección de memoria indicada.
     * @param {number} pc 
     */
    pausarEn(pc){
        this.cPUDebug.breakpointsSet.add(pc);
    }
