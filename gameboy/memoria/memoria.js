...
import { RegistrosAudio } from "./registros/registros_audio.js";
import { RegistrosCanal1 } from "./registros/registros_canal1.js";
import { RegistrosCanal2 } from "./registros/registros_canal2.js";
import { RegistrosCanal3 } from "./registros/registros_canal3.js";
import { RegistrosCanal4 } from "./registros/registros_canal4.js";
import { RegistrosLCD } from "./registros/registros_lcd.js";
import { RegistrosBotones } from "./registros/registros_botones.js";
import { RegistrosInterrupciones } from "./registros/registros_interrupciones.js";

import{
    GB_TIPO_CARTUCHO_ROM_SOLO,
    GB_TIPO_CARTUCHO_MBC1,
    GB_TIPO_CARTUCHO_MBC2,
    GB_TIPO_CARTUCHO_MBC2_BATERIA,
    GB_TIPO_CARTUCHO_MMM01,
    GB_TIPO_CARTUCHO_MBC3_TIMER_BATERIA,
    GB_TIPO_CARTUCHO_MBC3,
    GB_TIPO_CARTUCHO_MBC5,
    GB_TIPO_CARTUCHO_MBC5_VIBRACION,
    GB_TIPO_CARTUCHO_MBC6,
    GB_TIPO_CARTUCHO_POCKET_CAMERA,
    GB_TIPO_CARTUCHO_BANDAI_TAMA5,
    GB_TIPO_CARTUCHO_HuC3,
    GB_TIPO_CARTUCHO_ROM_RAM,
    GB_TIPO_CARTUCHO_ROM_RAM_BATERIA,
    GB_TIPO_CARTUCHO_MBC1_RAM,
    GB_TIPO_CARTUCHO_MBC1_RAM_BATERIA,
    GB_TIPO_CARTUCHO_MBC3_RAM,
    GB_TIPO_CARTUCHO_MBC3_RAM_BATERIA,
    GB_TIPO_CARTUCHO_MBC3_TIMER_RAM_BATERIA,
    GB_TIPO_CARTUCHO_MBC5_RAM,
    GB_TIPO_CARTUCHO_MBC5_RAM_BATERIA,
    GB_TIPO_CARTUCHO_MBC5_VIBRACION_RAM,
    GB_TIPO_CARTUCHO_MBC5_VIBRACION_RAM_BATERIA,

    GB_TAMANO_MEMORIA,

    GB_BOTONES_REG,
    GB_PANTALLA_REG_CONTROL,
    GB_PANTALLA_REG_ESTADO,
    GB_PANTALLA_REG_SCROLLY,
    GB_PANTALLA_REG_SCROLLX,
    GB_PANTALLA_REG_LY_COORD,
    GB_PANTALLA_REG_LYC_COMP,
    GB_PANTALLA_REG_WX,
    GB_PANTALLA_REG_WY,
    GB_PALETA_REG_BG,
    GB_PALETA_REG_OBP0,
    GB_PALETA_REG_OBP1,
    GB_TEMPORIZADOR_REG_DIV,
    GB_INTERRUPCIONES_REG_IF,
    GB_TEMPORIZADOR_REG_TAC,
    GB_TEMPORIZADOR_REG_TIMA,
    GB_TEMPORIZADOR_REG_TMA,
    GB_SONIDO_REG_NR52,
    GB_SONIDO_REG_NR51,
    GB_SONIDO_REG_NR50,
    GB_SONIDO_REG_NR10,
...
export class Memoria{
     ...
     * @param {RegistrosBotones} regBot  Registros IO de botones
     ...
     * @param {Uint8Array} guardado Archivo de guardado, se copia a SRAM
     */
    constructor(
        rOM, regLCD, regInt, regBot, regAud, 
        regCnl1, regCnl2, regCnl3, regCnl4, 
        cPUDebug, guardado, estado=null){
    ...
    /**
     * Realiza una transferencia DMA a la OAM desde la dirección especificada.
     * @param {*} dato 
     */
    ...
    /**
     * Actualiza un registro de 8 bits (1 byte) en la dirección de memoria indicada.
     * @param {*} indice 
     * @param {*} dato 
     */
